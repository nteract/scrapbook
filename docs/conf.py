...
htmlhelp_basename = "scrapbookdoc"
...
latex_documents = [
    (master_doc, "scrapbook.tex", "scrapbook Documentation", "nteract team", "manual")
]
...
man_pages = [(master_doc, "scrapbook", "scrapbook Documentation", [author], 1)]
